...
class SolvenciaModal extends Controller
{
    function index()
    {
      ...
      if($total_row > 0)
      {
             ...
             foreach($students as $fila)
       {
        ...
        <tr> 
         ...
         <td><a title="Pagar" disabled="disabled" class="btn btn-xs btn-info" href="'.action("SolvenciaController@show", $row->idper) .'" ><span class="icon icon-eye"></span>Pagar</a></td>
        </tr>
        ...
        <tr> 
         ...
         <td><a title="Pagar" class="btn btn-xs btn-info" href="'.action("SolvenciaController@show", $row->idper) .'" ><span class="icon icon-eye"></span>Pagar</a></td>
        </tr>
