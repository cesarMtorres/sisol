...
class CepirModal extends Controller
{
    function index()
    {
      ...
      if($total_row > 0)
      {
             ...
             foreach($students as $fila)
       {
        ...
        <tr> 
         ...
         <td><a title="ver"  class="btn btn-xs btn-info" href="'.action("CepirController@show", $row->idagre) .'" ><span class="icon icon-eye"></span>ver</a></td>
        </tr>
