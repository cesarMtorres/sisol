              ...
              <div class="row">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="telefono" id="civ" pattern=".{0}|.{11,11}" title="Requiere (11 caracteres)"  OnkeyPress="return SoloNumeros(event)" maxlength="11" class="form-control input-sm" value="{{ old('civ')}}">
                  </div>
                </div>
                <div class="col-xs-6 col-sm-6 col-md-6">
                  <div class="form-group">
