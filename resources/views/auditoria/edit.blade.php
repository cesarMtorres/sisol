          ...
          <div class="table-container">
            <form method="POST" action="{{ route('auditoria.update',$auditorias->id) }}"  role="form">
             ...
             <label>Status</label>
                ...
                <textarea name="observacion_final" id="observacion_final" class="form-control input-sm" pattern=".{0}|.{10,150}" title="Requiere minimo de (15 caracteres)" onkeyup="javascript:this.value=this.value.toUpperCase();" maxlength="150" required="required" placeholder="Observación Final">{{$audita->observacion_final}}</textarea>
              </div>
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                     ...
                     <label>Status</label>
                     <select class="form-control input-sm" required="required" data-placeholder="Seleccione" style="width: 70%;" disabled="disabled" name="status" id="status">
                   ...
                   <div class="col-xs-6 col-sm-6 col-md-6">
                <label>Observación Final</label>
                <textarea name="observacion_final" id="observacion_final" class="form-control input-sm" pattern=".{0}|.{10,150}" title="Requiere minimo de (15 caracteres)" onkeyup="javascript:this.value=this.value.toUpperCase();" maxlength="150" required="required" placeholder="Observación Final" disabled="disabled">{{$audita->observacion_final}}</textarea>
              </div>
