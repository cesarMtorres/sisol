...
<div class="col-md-8 col-sm-8">
                    ...
                    <input type="hidden" name="agremiado_id" value="{{$agremiados->id}}">
                     ...
                     @endforeach
                      @endforeach
                       ...
                       <input type="hidden" id="tipo_certificado" name="tipo_certificado" value="CEPIR">

                        <input type="hidden" id="cepir_id" name="cepir_id" value="{{$cepir->id}}">
        ...
        <div class="panel panel-primary setup-content" id="step-2">
            <div class="panel-heading" style="background: #34495e">
                 <h3 class="panel-title">Monto Total de la Obra</h3>
            </div>
            <div class="panel-body">
                 <div class="form-group">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6">
                  <div id="precio" class="form-inline">
                    <label>Monto</label>
                    <input type="text" name="monto5" id="monto5" OnkeyPress="return SoloNumeros(event)" maxlength="25" required="required" class="form-control input-sm" value="" style="width: 250px">
                     <input type="hidden" name="monto" id="monto" hidden="hidden" maxlength="25"  class="form-control input-sm" value="" style="width: 250px">
                  </div>
                </div>
                </div>
                ...
                <table class="table table-hover">
                    <thead>
                        ...
                        <th></th>
                            ...
                            <th>Certificado</th>
                            <th class="text-center">Monto de la obra</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                        ...
                        <td></td>
                           <td  class="col-md-4"><em>CEPIR</em></td>
...
$(document).ready(function(){
 ...
 $(document).on('keyup', '#search', function(){
  ...
  $(document).ready(function () {
        $("#monto5").keyup(function () {
       
            var value = $(this).val();
             var stotal=value*1;
            var sutotal=stotal/1.16;
             var total=sutotal/1000;


            $("#monto2").html(value);

            $("#monto22").html(value);
            $("#sutotal").html(sutotal.toFixed(2));
             $("#totalsueldo").html(total.toFixed(2));
