    ...
    <div class="col">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-title">Reportes de Solvencias</h3>
        </div>
        <div class="panel-body">    
        <div class="panel-tittle">
          <div class=""><h3>Lista de Solvencias segun su fecha de inclusión en el sistema</h3></div>
          <div class="row">
           <form method="POST" action="{{ route('agremiado.imprimirsol') }}"  role="form">
              {{ csrf_field() }}
           ...
           <button class="btn btn-danger" type="submit">Imprimir</button>
             ...
             <br>
                <div class="panel-body">    
        <div class="panel-tittle">
          <div class=""><h3>Lista de Solvencias segun su fecha de Nacimiento</h3></div>
          <div class="row">
