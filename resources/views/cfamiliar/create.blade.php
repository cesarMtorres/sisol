    ...
    <div class="col">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-title">Nuevo Carga Familiar</h3>
        </div>
        <div class="panel-body">          
          <div class="table-container">
            <form method="POST" action="{{ route('cfamiliar.store') }}"  role="form">
              @csrf
              <div class="row">
              ...
              <div class="form-group">
                ...
                <textarea name="direccion" class="form-control input-sm" title="Requiere minimo de (6 caracteres)" pattern=".{0}|.{6,150}" title="Requiere minimo de (6 caracteres)"  OnkeyPress="return SoloLetras(event)" maxlength="150" onkeyup="javascript:this.value=this.value.toUpperCase();" >{{ old('direccion')}}</textarea>
              </div>
              <div class="row">
                ...
                <div class="col-xs-6 col-sm-6 col-md-4">
                  <div class="form-group">
                    ...
                    <input type="date" name="fecha_nacimiento" id="fecha" class="form-control input-sm" onblur="calc()" onkeyup="javascript:this.value=this.value.toUpperCase();" value="{{ old('fecha_nacimiento') }}">
                  </div>
                </div>
                <div class="col-xs-6 col-sm-6 col-md-4">
                  <div class="form-group">
             ...
             <br>
             <div id="sms"></div>
              <a href="{{ route('cfamiliar.index') }}" class="btn btn-info">Atras</a>
